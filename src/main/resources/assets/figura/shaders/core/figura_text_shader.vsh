...
void main() {
    // Convert pos from part space -> camera-relative world space
    vec4 pos; vec3 _unused = vec3(0);
    figura_apply_transforms(Position, RiggingWeights, RiggingIndices, _unused, _unused, pos, _unused, _unused, vertexColor, lightUV);
    vertexColor *= Color;
    // Get fog
